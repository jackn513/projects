...
public class TestingDatabaseConfig {
    ...
    private static final String DB_NAME =
            Objects.requireNonNullElse(System.getenv("DB_NAME"), "musicDB_testing.sql");
    ...
    public DataSource dataSource() throws SQLException {
        ...
        ScriptUtils.executeSqlScript(dataSource.getConnection(), new ClassPathResource("musicDB_testing.sql"));
